...
import { useBackgroundImageLoader } from "@/components/rtl/use-background-image/use-background-image";
import HeaderTwo from "@/components/rtl/layout/header-two";
import Footertwo from "@/components/rtl/layout/footer-two";
import LeftCarousal from "@/components/rtl/left-carousal/left-carousal";
import SunnyWeather from "@/components/rtl/sunny-wether/sunny-weather";
...
const page = () => {
    ...
    useRemoveBodyClass(['home-seven', 'layout-rtl', 'boxed-layout'], ['home-nine', 'home-two', 'home-six']);
