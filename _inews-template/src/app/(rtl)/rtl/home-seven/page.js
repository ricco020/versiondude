...
import RainyWeather from "@/components/rtl/rainy-weather/rainy-wether";
...
import LeftCarousalThree from "@/components/rtl/left-carousal-three/left-carousal-three";
      ...
      <main className="page_main_wrapper">
        ...
        <section className="slider-inner">
          <div className="container">
            <div className="row thm-margin slider-shadow">
          ...
          <div className="row row-m">
            ...
            <div className="col-sm-5 col-md-4 col-p rightSidebar">
              <StickyBox>
                ...
                <div className="weather-wrapper-2">
                  <div className="weather-temperature">
                    <div className="weather-now">
                      <span className="big-degrees">43</span>
                ...
                <div className="align-items-center d-flex fs-6 justify-content-center  text-center social-counter-total">
