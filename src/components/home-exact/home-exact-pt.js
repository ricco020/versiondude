            ...
            <div className="col-md-3 leftSidebar d-none d-xl-block">
              <StickyBox>
                <div className="panel_header">
                  <h4><strong>Top </strong> Histórias</h4>
                </div>
                ...
                <div className="tabs-wrapper">
                  <ul className="nav nav-tabs" id="myTab" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button className="nav-link border-0 active" id="most-viewed" data-bs-toggle="tab" data-bs-target="#most-viewed-pane" type="button" role="tab" aria-controls="most-viewed-pane" aria-selected="true">Mais lidos</button>
                    </li>
                    <li className="nav-item" role="presentation">
            ...
            <div className="col-sm-5 col-md-4 col-xl-3 rightSidebar">
              <StickyBox>
                ...
                <div className="panel_inner review-inner">
                  <div className="panel_header">
                    <h4><strong>Explorar</strong> as categorias</h4>
                  </div>
                  <div className="panel_body">
                    ...
                    <div className="text-center mt-3">
                      <a href={LOC === "en" ? "/categories" : `/${LOC}/categories`} className="fw-bold text-primary-hover"><u>Ver todas as categorias</u></a>
                    </div>
                  </div>
                </div>
                ...
                <div className="panel_inner review-inner">
                  <div className="panel_header">
                    <h4><strong>Recentes</strong> Análises</h4>
                  </div>
                  <div className="panel_body">
                    {reviews[0] && (
                ...
                <StickyBox>
                  ...
                  <div className="panel_inner">
                    <div className="panel_header" style={{ marginTop: "2.5rem" }}>
                      <h4><strong>Ferramentas &amp;</strong> Standards</h4>
                    </div>
                    <div className="panel_body">
                      {toolsStacks[0] && (
                  ...
                  <div className="panel_inner mb-0">
                    <div className="panel_header">
                      <h4><strong>ESCOLHAS</strong> DA REDAÇÃO</h4>
                    </div>
                    <div className="panel_body">
                      <div className="border-bottom">
                ...
                <StickyBox>
                  ...
                  <div className="post-inner">
                    <div className="post-head" style={{ marginTop: "2.5rem" }}>
                      <h2 className="title"><strong>Recentes</strong> artigos</h2>
                    </div>
