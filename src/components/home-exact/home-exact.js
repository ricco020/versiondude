                ...
                <div className="tabs-wrapper">
                  <ul className="nav nav-tabs" id="myTab" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button className="nav-link border-0 active" id="most-viewed" data-bs-toggle="tab" data-bs-target="#most-viewed-pane" type="button" role="tab" aria-controls="most-viewed-pane" aria-selected="true">Most Viewed</button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button className="nav-link border-0" id="popular-news" data-bs-toggle="tab" data-bs-target="#popular-news-pane" type="button" role="tab" aria-controls="popular-news-pane" aria-selected="false">Popular news</button>
                    </li>
                  </ul>
            ...
            <div className="col-sm-5 col-md-4 col-xl-3 rightSidebar">
              <StickyBox>
                ...
                <div className="panel_inner review-inner">
                  <div className="panel_header">
                    <h4><strong>Browse</strong> categories</h4>
                  </div>
                  <div className="panel_body">
                    ...
                    <div className="text-center mt-3">
                      <a href={LOC === "en" ? "/categories" : `/${LOC}/categories`} className="fw-bold text-primary-hover"><u>View all categories</u></a>
                    </div>
                  </div>
                </div>
                ...
                <StickyBox>
                  ...
                  <div className="panel_inner">
                    <div className="panel_header" style={{ marginTop: "2.5rem" }}>
                      <h4><strong>Tooling &amp;</strong> Standards</h4>
                    </div>
                    <div className="panel_body">
                      {toolsStacks[0] && (
                  ...
                  <div className="panel_inner mb-0">
                    <div className="panel_header">
                      <h4><strong>EDITOR'S</strong> PICKS</h4>
                    </div>
                    <div className="panel_body">
                      <div className="border-bottom">
                ...
                <StickyBox>
                  ...
                  <div className="post-inner">
                    <div className="post-head" style={{ marginTop: "2.5rem" }}>
                      <h2 className="title"><strong>Latest</strong> articles</h2>
                    </div>
