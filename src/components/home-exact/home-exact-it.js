                    ...
                    <div className="slider-post post-height-4">
                      ...
                      <div className="post-text">
                        ...
                        <ul className="align-items-center authar-info d-flex flex-wrap gap-1">
                          <li>Da <span className="editor-name">VersionDude</span></li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <div className="col-md-3 leftSidebar d-none d-xl-block">
              <StickyBox>
                <div className="panel_header">
                  <h4><strong>Top </strong> Storie</h4>
                </div>
                ...
                <div className="tabs-wrapper">
                  <ul className="nav nav-tabs" id="myTab" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button className="nav-link border-0 active" id="most-viewed" data-bs-toggle="tab" data-bs-target="#most-viewed-pane" type="button" role="tab" aria-controls="most-viewed-pane" aria-selected="true">I più letti</button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button className="nav-link border-0" id="popular-news" data-bs-toggle="tab" data-bs-target="#popular-news-pane" type="button" role="tab" aria-controls="popular-news-pane" aria-selected="false">Popolari</button>
                    </li>
                  </ul>
            ...
            <div className="col-sm-5 col-md-4 col-xl-3 rightSidebar">
              <StickyBox>
                ...
                <div className="panel_inner review-inner">
                  <div className="panel_header">
                    <h4><strong>Esplora</strong> le categorie</h4>
                  </div>
                  <div className="panel_body">
                    ...
                    <div className="text-center mt-3">
                      <a href={LOC === "en" ? "/categories" : `/${LOC}/categories`} className="fw-bold text-primary-hover"><u>Vedi tutte le categorie</u></a>
                    </div>
                  </div>
                </div>
                ...
                <div className="panel_inner review-inner">
                  <div className="panel_header">
                    <h4><strong>Ultimi</strong> Recensioni</h4>
                  </div>
                  <div className="panel_body">
                    {reviews[0] && (
                ...
                <StickyBox>
                  ...
                  <div className="panel_inner">
                    <div className="panel_header" style={{ marginTop: "2.5rem" }}>
                      <h4><strong>Strumenti &amp;</strong> Standards</h4>
                    </div>
                    <div className="panel_body">
                      {toolsStacks[0] && (
                  ...
                  <div className="panel_inner mb-0">
                    <div className="panel_header">
                      <h4><strong>SCELTE</strong> DELLA REDAZIONE</h4>
                    </div>
                    <div className="panel_body">
                      <div className="border-bottom">
                ...
                <StickyBox>
                  ...
                  <div className="post-inner">
                    <div className="post-head" style={{ marginTop: "2.5rem" }}>
                      <h2 className="title"><strong>Ultimi</strong> articoli</h2>
                    </div>
