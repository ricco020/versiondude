...
import LeftCarousalTwo from "@/components/ltr/left-carousal-two/left-carousal-two";
...
const page = () => {
    ...
    useRemoveBodyClass(['None'], ['home-seven', 'home-two', 'home-nine', 'boxed-layout', 'home-six']);
    return (
        <LayoutTwo>
