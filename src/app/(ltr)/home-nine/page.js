...
import FeatureCarousal from "@/components/ltr/feature-carousal/feature-carousal";
import NewsCarousal from "@/components/ltr/news-carousal/news-carousal";
...
const page = () => {
    ...
    useRemoveBodyClass(['home-six'], ['home-seven', 'home-nine', 'boxed-layout', 'home-two']);
    return (
        <LayoutTwo>
                ...
                <section className="slider-inner">
                    <div className="container">
                        <div className="row slider-right-post thm-margin">
                            <div className="col-6 col-md-3 thm-padding">
                                <div className="slider-post post-height-3">
                                    <a href="#" className="news-image">
                                        <img src="/assets/images/slider-260x460-3.jpg" alt="" />
                                    </a>
                            ...
                            <div className="col-6 col-md-3 thm-padding">
                                <div className="slider-post post-height-3">
                                    <a href="#" className="news-image">
                                        <img src="/assets/images/slider-260x460-4.jpg" alt="" />
                                    </a>
                                    <div className="post-text">
                            ...
                            <div className="col-6 col-md-3 thm-padding">
                                <div className="slider-post post-height-3">
                                    <a href="#" className="news-image">
                                        <img src="/assets/images/slider-260x460-5.jpg" alt="" />
                                    </a>
                                    <div className="post-text">
                                        <span className="post-category">Technology</span>
                                        <h4>
                            ...
                            <div className="col-6 col-md-3 thm-padding">
                                <div className="slider-post post-height-3">
                                    <a href="#" className="news-image">
                                        <img src="/assets/images/slider-260x460-6.jpg" alt="" />
                                    </a>
                                    <div className="post-text">
                                        <span className="post-category">Travel</span>
                                        <h4>
                        ...
                        <div className="col-sm-7 col-md-8 col-p main-content">
                            <StickyBox>
                                ...
                                <div className="post-inner post-inner-2">
                                    ...
                                    {/* footer post */}
                                    <div className="post-footer">
                                        <div className="row thm-margin mb-2">
                                            <div className="col-md-8 thm-padding">
                                                <a href="#" className="more-btn">
                                                    More popular posts
                                                </a>
