...
import HeaderTwo from "@/components/ltr/layout/header-two";
import Footertwo from "@/components/ltr/layout/footer-two";
...
const page = () => {
    ...
    useRemoveBodyClass(['home-seven', 'boxed-layout'], ['home-six', 'home-two', 'home-nine']);
