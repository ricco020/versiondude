...
export function generateMetadata({params}){const x=findArticleBySlug(params.slug,LOC);if(!x)return{};return{title:`${x.title} — VersionDude`,description:x.dek,robots:{index:true,follow:true},alternates:{canonical:`https://versiondude.net/${LOC}/articles/${x.slug}`}};}
