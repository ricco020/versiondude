...
import CloudyWeather from "@/components/rtl/cloudy-weather/cloudy-weather";
import PollWidget from "@/components/rtl/poll-widget/poll";
import NewsTicker from "@/components/rtl/news-ticker-carousal/page";
import CenterCarousal from "@/components/rtl/center-carousal/center-carousal";
import PopularPostCarousalTwo from "@/components/rtl/popular-post-carousal-two/popular-post-carousal-two";
...
const page = () => {
    ...
    useRemoveBodyClass(['None','layout-rtl'], ['home-seven', 'home-nine', 'boxed-layout', 'home-six', 'home-two']);
    return (
        <LayoutTwo>
                ...
                <section className="slider-inner">
                    <div className="container">
                        <div className="row thm-margin">
                            <div className="col-md-3 thm-padding">
                ...
                <div className="container">
                    <div className="row row-m">
                        ...
                        <div className="col-sm-5 col-md-4 col-p rightSidebar">
                            <StickyBox>
                                {/* START WEATHER */}
                                <div className="weather-wrapper-2">
                                    <div className="weather-temperature">
                                        <div className="weather-now">
                                            <span className="big-degrees">65</span>
